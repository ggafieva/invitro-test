...
Функция: Cтраница Сдать анализы
  ...
  Сценарий: Сверка цены продукта на странице анализы с ценой в корзине
    ...
    И ожидаем 3 сек
    И записать в переменную "cartPrice" значение элемента с xpath "//div[text()='Продукты:']/following-sibling::div//span"
    Тогда значения переменных "price" и "cartPrice" равны